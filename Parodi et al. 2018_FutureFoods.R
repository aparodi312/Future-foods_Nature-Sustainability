...
Nutritional_ff <- read.csv("//wurnet.nl/Homes/parod001/AppData/FolderRedirection/Desktop/Dataset for paper/Nutritional_ff.csv")
...
Envimpacts_ff <- read.csv("//wurnet.nl/Homes/parod001/AppData/FolderRedirection/Desktop/Dataset for paper/Envimpacts_ff.csv")
...
Leip_impacts <- read.csv("//wurnet.nl/Homes/parod001/AppData/FolderRedirection/Desktop/Dataset for paper/Leip_impacts.csv")
...
combinatie2 <- combinatie %>% separate(x, c("Component", "Units", "Author", "Species", "Weight", "Feed", "Typefood", "Value", "proteinvalue", "value1gprot"), "_")
...
requirements <- read.csv("//wurnet.nl/Homes/parod001/AppData/FolderRedirection/Desktop/Dataset for paper/requirements.csv")
